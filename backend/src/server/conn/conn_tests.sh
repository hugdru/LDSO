...
curl -X GET "http://localhost:8080/getMainGroup?tag=_id&type=int&value=5"
...
curl -X GET "http://localhost:8080/getSubGroup?tag=name&type=string&value=Paralelo"

curl -X GET "http://localhost:8080/updateSubGroup?_id=3&tag=name&type=string&value=Paralelinho"

curl -X GET "http://localhost:8080/getSubGroup?tag=name&type=string&value=Paralelinho"
...
curl -X GET "http://localhost:8080/getCriterion?tag=name&type=string&value=xpto"

curl -X GET "http://localhost:8080/updateCriterion?_id=3&tag=name&type=string&value=yqup"

curl -X GET "http://localhost:8080/getCriterion?tag=name&type=string&value=yqup"
...
curl -X GET "http://localhost:8080/getAccessibility?tag=_id&type=int&value=9"
