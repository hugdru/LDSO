...
--   (1, 1, "The outside", "Dragonlair", "https://3.bp.blogspot.com/-ZbjmUcASPhY/V3ZC1CySEGI/AAAAAAABJMQ/u8ADqFqPJRETL3crIYv6mk-1YGD5lKvAACLcB/s1600/Estadio-do-Dragao-Porto.jpg", current_timestamp);
--
...
--   (1, (SELECT id FROM country where name LIKE "portugal"), "FC Porto", "fcporto@fcporto.pt", "fcporto", "fcporto", "https://lh6.googleusercontent.com/-W_SiEiCY4jw/AAAAAAAAAAI/AAAAAAAAkro/7hjZq8nT5TY/s0-c-k-no-ns/photo.jpg", NULL, NULL, NULL, 22 557 0400);
--
